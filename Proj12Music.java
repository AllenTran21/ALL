...
//}
     ...
     */
    public static void handlePrintCollection(ArrayList<Album> arrayMusicCollection, int songsInArray) {
        //Album.printAlbum(musicCollection, songsInArray);
        for (int i = 0; i < songsInArray; i++) {
            System.out.println(arrayMusicCollection);
        }
    }
...
//        System.out.println("Year:   " + musicCollection[position].getYear());
        System.out.println(musicCollection[position]);

    }

    public static void handleLoadCollection(ArrayList<Album> arrayMusicCollection, Scanner input) {
        ...
        try {
            ...
            artist = artist.substring(8, artist.length());
            String year = inputScanner.nextLine();
            year = year.substring(8, year.length());
            
        arrayMusicCollection.add(new Album(title, artist, Integer.parseInt(year)));
            
        } catch (FileNotFoundException ex) {
            System.out.println("File " + userInput + " not found");
        }
    }
        ...
        do {
            ...
            switch (userInput) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    handlePrintCollection(arrayMusicCollection, songsInArray);
                    break;
                case 5:
                ...
                case 6:
                    ...
                    break;
                case 7:
                    handleLoadCollection(arrayMusicCollection, input);
                    break;
                case 8:
